...
cd /home/vagrant/ss/sdk/RCM/StrategyStudio/examples/strategies/$GROUP_DIR/$STRATEGY_DIR/provision_scripts
# # Path to your Python script
python_script="results_analytics.py"
json_file_path="/home/vagrant/ss/sdk/RCM/StrategyStudio/examples/strategies/$GROUP_DIR/$STRATEGY_DIR/backtest_data.json"
