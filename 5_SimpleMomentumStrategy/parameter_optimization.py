...
class ParameterOptimisation:
    def __init__(
        self,
        optim_id=None,
        results_path="/groupstorage/group07/SimpleMomentum/",
    ):
...
if __name__ == "__main__":
    ...
    parameters = {
        "aggressivenes": {"dtype": "float", "values": [0.0, 1.0]},
        "position_size": {"dtype": "int", "values": [10, 300]},
        "short_window_size": {"dtype": "int", "values": [5, 20]},
        "long_window_size": {"dtype": "int", "values": [20, 60]},
    }
